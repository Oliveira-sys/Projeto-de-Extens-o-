    ...
    <div className="w-full min-h-screen bg-gray-50 text-gray-800 flex flex-col font-sans antialiased m-0 p-0 overflow-x-hidden">
      ...
      <div className="w-full flex-1 flex flex-col relative">
        <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-emerald-100/70 text-xs leading-relaxed">
                          Relate buracos na rua, falta de água ou iluminação
                          pública.
                        </p>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-blue-100/70 text-xs leading-relaxed">
                          Consulte em tempo real o andamento usando o seu
                          protocolo.
                        </p>
                      </div>
                    </button>
              ...
              <div className="w-full max-w-7xl mx-auto px-6 py-16">
                ...
                {erroConexao ? (
                  ...
                  <p className="text-center text-slate-400 animate-pulse">
                    Carregando ocorrências do banco...
                  </p>
                ) : denuncias.length === 0 ? (
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200/80 w-full">
                {!protocoloGerado ? (
                  <>
                    ...
                    <form onSubmit={handleCriarDenuncia} className="space-y-4">
                      ...
                      <textarea
                        required
                        rows="4"
                        placeholder="Detalhe o ocorrido informando o local..."
                        value={novaDescricao}
                      ...
                      <div className="flex gap-4">
                        <button
                          ...
                          className="w-1/2 border py-3 rounded-lg font-bold text-sm"
                        >
                          Cancelar
                        </button>
                        <button
                          type="submit"
                          disabled={enviando}
                          className="w-1/2 bg-emerald-600 text-white py-3 rounded-lg font-bold text-sm"
                        >
                  ...
                  <div className="text-center py-6">
                    ...
                    <h2 className="text-2xl font-black text-emerald-600 mb-1">
                      Ocorrência Protocolada!
                    </h2>
                    <p className="text-gray-500 text-sm mb-6">
                      Guarde o código gerado pelo sistema.
                    </p>
                    ...
                    <button
                      ...
                      className="bg-slate-900 text-white px-6 py-3 rounded-lg font-bold text-sm"
                    >
                    ...
                    <button
                      ...
                      className="text-slate-500 font-bold block text-xs mx-auto mt-4"
                    >
                      Voltar ao Início
                    </button>
                  </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200/80 w-full">
                ...
                >
                  <input
                    ...
                    className="border p-3 rounded-lg flex-1 text-center font-mono font-black text-xl"
                  />
                  <button
                    type="submit"
                    disabled={buscando}
                    className="bg-blue-600 text-white px-6 rounded-lg font-bold text-sm"
                  >
                    {buscando ? "..." : "Pesquisar"}
                  </button>
                </form>
                ...
                {denunciaEncontrada && (
                  <div className="border-t pt-4 space-y-3">
                    ...
                    <p className="text-sm bg-gray-50 p-4 rounded-xl">
                      <strong>Relato:</strong> {denunciaEncontrada.descricao}
                    </p>
                ...
                {erroBusca && (
                  <p className="text-center text-red-500 text-sm mt-4">
                    Nenhum registro encontrado com esse protocolo.
                  </p>
                )}
                <button
                  type="button"
                  ...
                  className="mt-6 text-gray-500 block text-sm mx-auto"
                >
                  Voltar
                </button>
              </div>
          ...
          {/* TELA 4: DASHBOARD PÚBLICO (ESTATÍSTICAS PARA TODOS) */}
          {tela === "estatisticas" && (
            <Dashboard
              denuncias={denuncias}
              getStatusBadge={getStatusBadge}
              fadeUpVariants={fadeUpVariants}
              handleMudarStatus={() => {}} // Função vazia para o modo público
            />
          )}
